...
{
    if(stripos($_SERVER["REQUEST_URI"],'/api/') === FALSE and  stripos($_SERVER["REQUEST_URI"],'/weauth') === FALSE)
    {
...
$config['ldap_host'] = '192.168.178.55';
...
//____________________________________________________________________________
//store bizplay information for request api
$config['CNTS_ID'] = "CNTS_1036";
$config['API_KEY'] = "c40a650e-ce68-48ea-a96e-56c554d91165";
