                ...
                <table cellpadding="0" cellspacing="0" border="0" class="display" id="users" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo lang('hr_employees_thead_khmer_name');?></th>
                            <th><?php echo lang('hr_employees_thead_korean_name');?></th>
                            <th><?php echo lang('hr_employees_thead_dob');?></th>
                            <th><?php echo lang('global_gender');?></th>
                            <th><?php echo lang('global_education');?></th>
                            <th><?php echo lang('global_topik_lvl');?></th>
                            <th><?php echo lang('hr_employees_thead_email');?></th>
                            <th><?php echo lang('global_phone_number_1');?></th>
                            <th><?php echo lang('global_phone_number_2');?></th>
                            ...
                            <th><?php echo lang('hr_employees_thead_dateleave');?></th>
...
<div id="context-menu">
  <ul class="dropdown-menu" role="menu">
        ...
        <li><a tabindex="-1" href="#" data-action="<?php echo base_url();?>hr/overtime/create/{id}"><i class="icon-plus"></i>&nbsp;<?php echo lang('hr_employees_thead_link_create_overtime');?></a></li>
