...
echo form_open('users/create', $attributes); ?>
    ...
    <label for="firstname"><?php echo lang('users_create_field_firstname');?> <span class="require">*</span></label>
    <input type="text" name="firstname" id="firstname" required /><br />

    <label for="lastname"><?php echo lang('users_create_field_lastname');?> <span class="require">*</span></label>
    <input type="text" name="lastname" id="lastname" required /><br />
    
    <label for="khmer_name"><?php echo lang('users_create_field_khmer_name');?></label>
    <input type="text" name="khmer_name" id="khmer_name"  /><br />
    
    <label for="korean_name"><?php echo lang('users_create_field_korean_name');?></label>
    <input type="text" name="korean_name" id="korean_name"  /><br />
    
    <label for="viz_dob"><?php echo lang('users_create_field_dob');?></label>
    <input type="text" id="viz_dob" name="viz_dob" /><br />
    <input type="hidden" name="dob" id="dob" />
    
    <label for="id_card"><?php echo lang('users_create_field_id_card');?></label>
    <input type="text" name="id_card" id="id_card"  /><br />
    
    <label for="role[]"><?php echo lang('users_create_field_gender');?></label>
    <select name="employee_gb" size="2" required>
	    <option value="M"><?php echo lang("users_create_field_gender_m") ?></option>
	    <option value="M"><?php echo lang("users_create_field_gender_f") ?></option>
    </select>
    
    <label for="education"><?php echo lang('users_create_field_education');?></label>
    <input type="text" name="education" id="education"  /><br />
    
    <label for="topik_lvl"><?php echo lang('users_create_field_topik_lvl');?></label>
    <input type="text" name="topik_lvl" id="topik_lvl" /><br />
    
    <label for="role[]"><?php echo lang('users_create_field_role');?> <span class="require">*</span></label>
    <select name="role[]" size="2" required>
    <?php foreach ($roles as $roles_item): ?>
        <option value="<?php echo $roles_item['id'] ?>" <?php if ($roles_item['id'] == 2) echo "selected"; ?>><?php echo $roles_item['name'] ?></option>
    <?php endforeach ?>
    </select>

    <label for="login"><?php echo lang('users_create_field_login');?> <span class="require">*</span></label>
    ...
    <label for="email"><?php echo lang('users_create_field_email');?> <span class="require">*</span></label>
    <input type="email" id="email" name="email" required /><br />
    
    <label for="cp1"><?php echo lang('users_create_field_phone_1');?></label>
    <input type="text" name="cp1" id="cp1" /><br/>
    
    <label for="cp2"><?php echo lang('users_create_field_phone_2');?></label>
    <input type="text" name="cp2" id="cp2" /><br/>

    <input type="hidden" name="manager" id="manager" /><br />
    <label for="txtManager"><?php echo lang('users_create_field_manager');?> <span class="require">*</span></label>
    <div class="input-append">
    ...
    <label for="txtEntity"><?php echo lang('users_create_field_entity');?> <span class="require">*</span></label>
    <div class="input-append">
        <input type="text" id="txtEntity" name="txtEntity" readonly  required/>
    ...
    <label for="txtPosition"><?php echo lang('users_create_field_position');?> <span class="require">*</span></label>
    <div class="input-append">
    ...
    <label for="viz_dateleave"><?php echo lang('users_create_field_leave');?></label>
    <input type="text" id="viz_dateleave" name="viz_dateleave" /><br />
    <input type="hidden" name="dateleave" id="dateleave" />
    ...
    <label for="password"><?php echo lang('users_create_field_password');?> <span class="require">*</span></label>
    <div class="input-append">
